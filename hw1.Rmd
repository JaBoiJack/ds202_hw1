...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: **Jack Langenwalter**. *Economics*. I transferred here from St. Thomas University up in the Twin Cities. I played tennis for St. Thomas for a smemester. I am from Indianola, Iowa which is just south of Des Moines and I am pursuing a minor in Data Science.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: Business intelligence. You have to acquire large sets of data and make them presentable using best practices of data visualization. 
    [Business intelligence](https://www.gartner.com/en/information-technology/glossary/business-intelligence-bi)
    ![modern analytics workflow](https://cdns.tblsft.com/sites/default/files/pages/modern_analytics_cycle.png)
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer:Jacks-MacBook-Pro-2:~ lang7715$ git --version
